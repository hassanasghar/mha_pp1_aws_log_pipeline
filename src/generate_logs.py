...
if __name__ == "__main__":
    # Decide output file name based on today's date
    today = date.today()
    date_str = today.strftime("%Y%m%d")  # e.g. 20260126
    output_path = f"data/logs_{date_str}.csv"

    # Number of rows (you can adjust later)
    generate_fake_logs(num_rows=1000, output_path=output_path)
